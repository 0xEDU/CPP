...
bool bsp(Point const a, Point const b, Point const c, Point const point) {
    ...
    Fixed a1 = area(point.getX(), point.getY(), b.getX(), b.getY(), c.getX(),
                    c.getY());

    Fixed a2 = area(a.getX(), a.getY(), point.getX(), point.getY(), c.getX(),
                    c.getY());

    Fixed a3 = area(a.getX(), a.getY(), b.getX(), b.getY(), point.getX(),
                    point.getY());
